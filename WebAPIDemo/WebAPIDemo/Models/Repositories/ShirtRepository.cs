namespace WebAPIDemo.Models.Repositories
{
    public static class ShirtRepository
    {
        private static List<Shirt> shirts = new List<Shirt>()
        {
            ...
            new Shirt{ShirtId = 3, Brand = "Your Brand", Color = "Red", Gender = "Men", Price = 45, Size = 15},
            new Shirt{ShirtId = 4, Brand = "Your Brand", Color = "Yellow", Gender = "Men", Price = 60, Size = 13}
        };
